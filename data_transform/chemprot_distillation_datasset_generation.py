...
prompt_ddi_file = r'../config/prompt_chemprot_think.txt'
...
if __name__ == '__main__':
    # ##
    src_file = r'../data/ChemProt/train_split_relation/train_deepseek.json'
    save_folder = r'../data\sft_dataset\chemprot-distillation'
    # ##
