...
def load_label_and_result_compute_f1_score(src_file, result_file):
    ...
    for obj in json_data:
        option_src = chemprot_relation_convert_to_option(obj['relation'])
        label = chemprot_option_convert_to_id(option_src)
    ...
    for obj in result_json_data:
        ...
        result_label = chemprot_option_convert_to_id(option)
        print(obj)
    ...
    # ##
    # labels_name = ['upregulator', 'downregulator', 'agonist', 'antagonist', 'participant']
    labels_name = ['CPR:3', 'CPR:4', 'CPR:5', 'CPR:6', 'CPR:9']
    cm = confusion_matrix(label_list, result_label_list)
    plot_confusion_matrix_jama(cm, classes=labels_name, title='Confusion Matrix of ChemProt', save_dir=r'results')


if __name__ == '__main__':
    # ##
    src_file = r'../data/ChemProt/test.json'
    result_file = r'../data/ChemProt/test_baseline.json'
