...
sft_model_path = r'../local_models\Meta-Llama-3.1-8B-Instruct'
sft_model_save_path = r'./checkpoints/Meta-Llama-3.1-8B-Instruct-sft-ddi-dd'
sft_dataset_path = r'./data/sft_dataset/ddi-distillation'
